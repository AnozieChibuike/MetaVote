    ...
    fetch(`${REACT_APP_SERVER_URL}/verify?token=${token}`)
      ...
      .then((data) => {
        if (data.email) {
          ...
          setMessage(<span>Verification successful! Redirecting...<br><span>If page doesn't automatically redirect, click this <a href="/admin">link</a></span></br></span>);
          if (!is_admin) setTimeout(() => navigate("/admin"), 2000);
